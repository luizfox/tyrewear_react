package luiz.tyreusage.repository;

import luiz.tyreusage.TyreusageApp;
import luiz.tyreusage.config.Constants;
import luiz.tyreusage.config.audit.AuditEventConverter;
import luiz.tyreusage.domain.PersistentAuditEvent;
...
import static luiz.tyreusage.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
